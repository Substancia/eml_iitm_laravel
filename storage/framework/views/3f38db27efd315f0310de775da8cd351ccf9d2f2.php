...
<html>
<head>
	<title>Extra Muarl Letures IIT Madras</title>
	...
	<script type="text/javascript" src="<?php echo e(url('js/jquery-3.1.0.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(url('js/bootstrap.js')); ?>"></script>
</head>
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	  <a class="navbar-brand" href="<?php echo e(url('/')); ?>">EML</a>
